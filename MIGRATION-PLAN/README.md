...
This pack contains everything needed to migrate from `promo-master` (old) to `promo-master-v2` (new).

| Item | Value |
|------|-------|
| **Duration** | 6 weeks |
| **Source** | promo-master (Next.js + NestJS, 867 files) |
| **Target** | promo-master-v2 (Vite + Vercel, 140 files) |
...
**This will:**
- ✅ KEEP: `promo-master` (reference)
- ✅ KEEP: `promo-master-v2` (main development)
- 📦 ARCHIVE: `promo-master-lambda` → `_archive/`
- 🗑️ DELETE: `promo-master-web` (duplicate)
...
|--------------|--------------|
| `promo-master/apps/web/app/(dashboard)/finance/` | `promo-master-v2/apps/web/src/pages/finance/` |
| `promo-master/apps/web/app/(dashboard)/planning/` | `promo-master-v2/apps/web/src/pages/planning/` |
| `promo-master/apps/web/app/(dashboard)/operations/` | `promo-master-v2/apps/web/src/pages/operations/` |
| `promo-master/apps/api/src/modules/` | `promo-master-v2/apps/api/api/` |
...
1. Check `promo-master` source code for reference
