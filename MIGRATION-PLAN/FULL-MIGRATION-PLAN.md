...
| Item | Details |
|------|---------|
| **Source** | promo-master (Next.js + NestJS) |
| **Target** | promo-master-v2 (Vite + Vercel Serverless) |
| **Duration** | 6 weeks |
...
```bash
# 1. Archive promo-master-lambda
mv /Users/mac/TPM-TPO/promo-master-lambda /Users/mac/TPM-TPO/_archive/

# 2. Delete promo-master-web (duplicate)
rm -rf /Users/mac/TPM-TPO/promo-master-web

# 3. Create migration branch in v2
cd /Users/mac/TPM-TPO/promo-master-v2
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/finance/accrual/
NEW: promo-master-v2/apps/web/src/pages/finance/accrual/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/finance/deductions/
NEW: promo-master-v2/apps/web/src/pages/finance/deductions/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/finance/gl-journals/
OLD: promo-master/apps/web/app/(dashboard)/finance/chequebook/
NEW: promo-master-v2/apps/web/src/pages/finance/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/planning/templates/
NEW: promo-master-v2/apps/web/src/pages/planning/templates/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/planning/scenarios/
NEW: promo-master-v2/apps/web/src/pages/planning/scenarios/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/planning/clash-detection/
NEW: promo-master-v2/apps/web/src/pages/planning/clash-detection/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/operations/delivery/
NEW: promo-master-v2/apps/web/src/pages/operations/delivery/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/operations/sell-tracking/
NEW: promo-master-v2/apps/web/src/pages/operations/sell-tracking/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/operations/inventory/
NEW: promo-master-v2/apps/web/src/pages/operations/inventory/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/integrations/erp/
NEW: promo-master-v2/apps/web/src/pages/integrations/erp/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/integrations/dms/
NEW: promo-master-v2/apps/web/src/pages/integrations/dms/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/settings/api-keys/
OLD: promo-master/apps/web/app/(dashboard)/settings/webhooks/
NEW: promo-master-v2/apps/web/src/pages/settings/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/settings/security/
NEW: promo-master-v2/apps/web/src/pages/settings/security/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/ai/
NEW: promo-master-v2/apps/web/src/pages/ai/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/components/voice/
NEW: promo-master-v2/apps/web/src/components/voice/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/app/(dashboard)/reports/builder/
NEW: promo-master-v2/apps/web/src/pages/reports/builder/
...
**Files to Migrate:**
```
OLD: promo-master/apps/web/components/excel/
NEW: promo-master-v2/apps/web/src/components/excel/
...
After 6 weeks:
1. Archive promo-master to _archive/
