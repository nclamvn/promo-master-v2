...
```
TPM-TPO/
├── promo-master/        ✅ KEEP (reference)
├── promo-master-v2/     ✅ KEEP (main)
└── _archive/
    └── promo-master-lambda-20260125/
```
...
```bash
# Export old schema
cat /Users/mac/TPM-TPO/promo-master/packages/database/prisma/schema.prisma > /tmp/schema-old.prisma

# Export new schema
cat /Users/mac/TPM-TPO/promo-master-v2/apps/api/prisma/schema.prisma > /tmp/schema-new.prisma
...
```bash
cd /Users/mac/TPM-TPO/promo-master-v2/apps/api
...
```bash
cd /Users/mac/TPM-TPO/promo-master-v2/apps/api/src
...
```bash
cd /Users/mac/TPM-TPO/promo-master-v2/packages/shared/src
