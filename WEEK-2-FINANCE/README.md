...
- **Old Code Reference:** `/Users/mac/TPM-TPO/promo-master/apps/web/app/(dashboard)/finance/`
- **Prisma Schema:** `/Users/mac/TPM-TPO/promo-master-v2/apps/api/prisma/schema.prisma`
- **Shared Types:** `/Users/mac/TPM-TPO/promo-master-v2/packages/shared/`
...
If stuck:
1. Check old code in `promo-master` for reference
