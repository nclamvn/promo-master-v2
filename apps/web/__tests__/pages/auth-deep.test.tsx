...
describe('Login - Deep Tests', () => {
  it('pre-fills email with admin credentials', () => {
    ...
    expect(emailInput.value).toBe('admin@promomaster.com');
  });
  ...
  it('renders demo credentials info', () => {
    ...
    expect(screen.getByText(/Admin: admin@promomaster.com/)).toBeInTheDocument();
    expect(screen.getByText(/Manager: manager@promomaster.com/)).toBeInTheDocument();
  });
  ...
  it('calls login on form submit', async () => {
    ...
    await waitFor(() => {
      ...
      expect(mockLogin).toHaveBeenCalledWith('admin@promomaster.com', 'admin123');
    });
  });
